...
![Swift Stream IDE Entering New Library Name](../assets/screenshots/new-name-android-lib.webp "Swift Stream IDE Entering New Library Name")
...
![Swift Stream IDE Selecting Library Template](../assets/screenshots/new-type-android-lib.webp "Swift Stream IDE Selecting Library Template")

Click **Create Project**

Next, enter the Java namespace for your library. This is usually your domain name in reverse (e.g., `com.example.mylib`).

![Swift Stream IDE Entering Library Namespace](../assets/screenshots/new-android-package-name.png "Swift Stream IDE Entering Library Namespace")
